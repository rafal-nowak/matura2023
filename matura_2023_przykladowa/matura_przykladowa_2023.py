...
class Matura2023Przykladowa:
    ...
    def zadanie_1_1(selfs):
        ...
        return positions_with_empty_columns, max_empty_columns

    def zadanie_1_2(self):
        ...
        return equal_positions, min_equal_pieces

    def zadanie_1_3(self):
        ...
        return white_rook_checks, black_rook_checks
