...
class TestMatura2023Maj(TestCase):
    def test_zadanie41(self):
        expected_number_of_searched_numbers = 18
        expected_first_number_as_text = "93639"

        number_of_searched_numbers, first_number_as_text = Matura2023Maj().zadanie41()
    ...
    def test_zadanie42(self):
        ...
        number_with_max_prime_factors, \
            ...
            max_number_of_different_prime_factors = Matura2023Maj().zadanie42()
    ...
    def test_zadanie43(self):
        ...
        numer_of_good_threes, good_threes, numer_of_good_fives, good_fives = Matura2023Maj().zadanie43()
